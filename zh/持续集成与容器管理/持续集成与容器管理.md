...
![img](assets/2.3.2-3.png)

（7）新建用户

![img](assets/2.3.2-4.png)
...
（3）Maven配置![img](assets/2.5.2-3.png)
...
![img](assets/2.6.1-2.png)

![img](assets/2.6.1-3.png)

![img](assets/2.6.1-4.png)
...
![img](assets/2.6.1-6.png)

（5）登录

![img](assets/2.6.1-7.png)

（6）创建仓库 ![img](assets/2.6.1-8.png)

![img](assets/2.6.1-9.png)
...
（3）在浏览器输入地址： [http://192.168.184.136:9090](http://192.168.184.136:9090/) 即可看到高端大气的欢迎页
